...
namespace qrk
{
	...
	public:
		...
		{
			q_3dDraw = qrk::assets::Program("shaders/3d_vertex_shader.vert", "shaders/3d_fragment_shader.frag");
			q_2dDraw = qrk::assets::Program("shaders/2d_vertex_shader.vert", "shaders/2d_fragment_shader.frag");
		}
